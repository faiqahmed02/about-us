...
class Skin_1 extends Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/premium-woo-products/section_image_style/after_section_end', array( $this, 'register_quick_style_controls' ) );
	...
	public function register_product_price_style( Widget_Base $widget ) {
