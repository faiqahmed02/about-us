...
class PA_Controls_Handler {
	...
	public function init_conditions() {
		...
		static::$conditions = array(
			...
			'ip_location'      => __( 'IP Location', 'premium-addons-for-elementor' ),
			...
			'user_role'        => __( 'User Role', 'premium-addons-for-elementor' ),
			'url_referer'      => __( 'URL Parameters (PRO)', 'premium-addons-for-elementor' ),
		);
